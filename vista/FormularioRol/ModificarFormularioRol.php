            ...
            <div class="register-box">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="./?c=formularioRol&a=ActualizarFormularioRol" method="post" autocomplete="off">
                            <input type="hidden" name="hdnIdFormularioRol" value="<?php echo $data["idFormularioRol"]; ?>">
                            <div class="form-group">
                                <label>Formulario</label>
                                <select name="slcidFormulario" class="form-control js-buscador" required>
                                    <option value="" selected disabled><?php echo $data["formularioRol"]["formuDescr"]; ?></option>
                                    <?php
                            ...
                            <div class="form-group">
                                ...
                                <select name="slcidRol" class="form-control js-buscador" required>
                                    <option value="" selected disabled><?php echo $data["formularioRol"]["rolDescr"]; ?></option>
                                    <?php
                                    $this->db = Conectar::conexion();
