                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Módulo Formularios</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="register-box">
                                <div class="card card-outline card-primary">
                                    ...
                                    <div class="card-body">
                                        <p class="login-box-msg">Registrar un nuevo formulario</p>

                                        <form action="./?c=formulario&a=Guardar" method="post" autocomplete="off">
                                            <div class="form-group">
                                                <label>Descripción</label>
                                                <input type="text" class="form-control" name="txtDescripcion" placeholder="Ingrese la descripción" maxlength="100" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Etiqueta</label>
                                                <input type="text" class="form-control" name="txtEtiqueta" placeholder="Ingrese la etiqueta" maxlength="50" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Ubicación</label>
                                                <input type="text" class="form-control" name="txtUbicacion" placeholder="Ingresa la ubicación" maxlength="100" required>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <button class="btn btn-block btn-primary">Crear Nuevo Formulario</button>
                                                </div>
                                                <div class="col">
