...
<body class="hold-transition">
  <div class="container-fluid">
    ...
    <div class="row mt-3">
      <div class="col">
        <a href="./?c=roles&a=ListarRoles"><button class="btn btn-sm btn-info">Regresar <i class="fas fa-undo"></i></button></a>
      </div>
    </div>
    <div class="row mt-3">
      <div class="col-md-12">
          ...
          <tbody>
            <tr>
              ...
              ?>
                ...
                <td>
                  <a href="./?c=roles&a=RestaurarRol&idData=<?php echo $dato['id_rol']; ?>"><button class="btn btn-sm btn-primary"><i class="fas fa-trash-restore"></i></button></a>
                  <a href="./?c=roles&a=ElimiDefinRol&idData=<?php echo $dato['id_rol']; ?>"><button class="eliminar btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></a>
                </td>
            </tr>
          <?php } ?>
          </tbody>
