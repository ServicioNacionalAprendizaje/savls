                        ...
                        <div class="col-md-12">
                            <div class="register-box">
                                <div class="card card-outline card-primary">
                                    ...
                                    <div class="card-body">
                                        <p class="login-box-msg">Registrar un nuevo usuario rol</p>

                                        <form action="./?c=usuarioRol&a=Guardar" method="post" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <button class="btn btn-block btn-primary">Crear nuevo usuario rol</button>
                                                </div>
                                                <div class="col">
