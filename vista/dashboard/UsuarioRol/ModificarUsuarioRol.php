            ...
            <div class="register-box">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="./?c=usuarioRol&a=ActualizarUsuarioRol" method="post" autocomplete="off">
                            <input type="hidden" name="hdnIdUsuarioRol" value="<?php echo $data["idUsuarioRol"]; ?>">
                            <div class="form-group">
                                <label>Rol</label>
                                <select name="slcidRol" class="form-control js-buscador" required>
                                    <option value="" selected disabled><?php echo $data["usuarioRol"]["descripcion"]; ?></option>
                                    <?php
                            ...
                            <div class="form-group">
                                <label>Usuario</label>
                                <select name="slcidUsuario" class="form-control js-buscador" required>
                                    <option value="" selected disabled><?php echo $data["usuarioRol"]["usuario"]; ?></option>
                                    <?php
                                    $this->db = Conectar::conexion();
                                    $sqlUsuarios = "SELECT * FROM usuario WHERE estado > 0";
                                    $resultado = $this->db->query($sqlUsuarios);
                                    while ($row = $resultado->fetch_array()) { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="./?c=usuarioRol&a=ListarUsuariosRol"><button type="button" class="btn btn-block btn-danger">Regresar</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
