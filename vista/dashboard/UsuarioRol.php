        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <a href="./?c=usuarioRol&a=Nuevo"><button class="btn btn-sm btn-info">Nuevo Usuario Rol <i class="fas fa-plus"></i></button></a>
                            <a href="./?c=usuarioRol&a=UsuariosRolEliminados"><button class="btn btn-sm btn-danger">Usuarios roles eliminados <i class="fas fa-trash"></i></button></a>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <?php
                                        $cont = 1;
                                        foreach ($data["usuariosRol"] as $dato) {
                                        ?>
                                            <td><?php echo $cont++; ?></td>
                                            ...
                                            <td>
                                                <a href="./?c=usuarioRol&a=ModificarUsuarioRol&idData=<?php echo $dato['id_usuario_rol']; ?>"><button class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></button></a>
                                                <a href="./?c=usuarioRol&a=EliminarUsuarioRol&idData=<?php echo $dato['id_usuario_rol']; ?>"><button class="eliminar btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></a>
                                            </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
