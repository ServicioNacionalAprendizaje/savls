...
<body class="hold-transition">
  <div class="container-fluid">
    ...
    <div class="row mt-3">
      <div class="col">
        <a href="./?c=persona&a=Listar&"><button class="btn btn-sm btn-info">Regresar <i class="fas fa-undo"></i></button></a>
      </div>
    </div>
    <div class="row mt-3">
      <div class="col-md-12">
          ...
          <tbody>
            <tr>
              ...
              ?>
                ...
                <td>
                  <a href="./?c=persona&a=RestaurarPersona&idData=<?php echo $dato['id_persona']; ?>"><button class="btn btn-sm btn-primary"><i class="fas fa-trash-restore"></i></button></a>
                  <a href="./?c=persona&a=ElimiDefinPerso&idData=<?php echo $dato['id_persona']; ?>"><button class="eliminar btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></a>
                </td>
            </tr>
          <?php } ?>
          </tbody>
