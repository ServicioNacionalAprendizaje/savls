            ...
            <div class="register-box">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="./?c=persona&a=ActualizarPersona" method="post" autocomplete="off">
                            <input type="hidden" name="hdnIdPersona" value="<?php echo $data["idPersona"]; ?>">
                            <div class="form-group">
                                <label>Nombres</label>
                                <input type="text" class="form-control" name="txtNombres" value="<?php echo $data["persona"]["nombre"]; ?>" placeholder="Ingrese sus nombres" maxlength="20" required>
                            </div>
                            <div class="form-group">
                                <label>Apellidos</label>
                                <input type="text" class="form-control" name="txtApellidos" value="<?php echo $data["persona"]["apellido"]; ?>" placeholder="Ingrese sus apellidos" maxlength="20" required>
                            </div>
                            <div class="form-group">
                                <label>Edad</label>
                                <input type="number" class="form-control" name="txtEdad" value="<?php echo $data["persona"]["edad"]; ?>" placeholder="Ingresa tu edad" maxlength="3" required>
                            </div>
                            <div class="form-group">
                                <label>Género</label>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rdoGenero" value="M" required selected>
