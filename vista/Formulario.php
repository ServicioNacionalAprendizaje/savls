        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <a href="./?c=formulario&a=Nuevo"><button class="btn btn-sm btn-info">Nuevo Formulario <i class="fas fa-plus"></i></button></a>
                            <a href="./?c=formulario&a=FormulariosEliminados"><button class="btn btn-sm btn-danger">Formularios eliminados <i class="fas fa-trash"></i></button></a>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <?php
                                        $cont = 1;
                                        foreach ($data["formularios"] as $dato) {
                                        ?>
                                            <td><?php echo $cont++; ?></td>
                                            <td><?php echo $dato["descripcion"]; ?></td>
                                            <td><?php echo $dato["etiqueta"]; ?></td>
                                            <td><?php echo $dato["ubicacion"]; ?></td>
                                            <td><?php echo $dato["fecha_modificacion"]; ?></td>
                                            <td>
                                                <a href="./?c=formulario&a=ModificarFormulario&idData=<?php echo $dato['id_formulario']; ?>"><button class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></button></a>
                                                <a href="./?c=formulario&a=EliminarFormulario&idData=<?php echo $dato['id_formulario']; ?>"><button class="eliminar btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></a>
                                            </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
