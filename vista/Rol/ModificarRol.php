            ...
            <div class="register-box">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="./?c=roles&a=ActualizarRol" method="post" autocomplete="off">
                            <input type="hidden" name="hdnIdRol" value="<?php echo $data["idRol"]; ?>">
                            <div class="form-group">
                                <label>Descripción</label>
                                <input type="text" class="form-control" name="txtDescripcion" value="<?php echo $data["rol"]["descripcion"]; ?>" placeholder="Ingrese sus nombres" maxlength="20" required>
                            </div>
                            <div class="row">
                                <div class="col">
